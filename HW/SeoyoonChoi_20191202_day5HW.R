...
hist(mtcars$wt, main = "Histogram for 중량",xlab = 
       "중량",ylab = "무게",border = "black",col = "yellow",las = 2 , breaks = 5)
...
boxplot(mpg~gear,data = mtcars, main = "gear/ mpg")

# 중앙값=2사분위   gear4 > gear5 > gear3
# 최대값 gear4 > gear5 > gear3
# 최소값 gear4 > gear5 > gear3
#gear가 4 일 때 mpg가 높은것으로 보여지며, 반대로 gear가 3일 때 mpg가 가장 낮았다 .
#gear가 3->4->5로 변하는 것에 따라, mpg도 증가하는 것을 볼 수 있다. 
